...
./bench_request_response_service 2>> ${LOG_DIR}/bench_request_response_service_stderr &
SERVICE_PID=$!
sleep 1;
...
./bench_request_response_client --${SYNC} --number-of-messages ${MESSAGES} --dont-shutdown-service \
    > ${LOG_DIR}/${SYNC}_${LOG_NAME}_loc \
    2>> ${LOG_DIR}/bench_request_response_client_loc_stderr
